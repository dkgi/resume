...
\renewcommand{\position}{POSITION\xspace}
\newcommand{\objective}{\position\ at \company\xspace}
\newcommand{\duration}{DURATION\xspace}

% Internship?
\newtoggle{internship}
\togglefalse{internship}
...
% Apply through cds international?
\newtoggle{stagiaire}
\togglefalse{stagiaire}				
\newcommand{\stagiairecountry}{Canada\xspace}
\newcommand{\stagiaireurl}{\url{http://www.canadainternational.gc.ca/switzerland-suisse/experience_canada_experience/choose_your_experience-choisissez_votre_experience.aspx?view=d}}
...
\newcommand{\interests}{% INTERESTS
		Software Engineering, Software Architecture, Software Verification, Concurrency, Computer Graphics, Simulation, Object Oriented Programming, Functional Programming, Scala, Java, C++
}
...
\newcommand{\familiarskills}{% FAMILIAR SKILLS
	VeriFast, PROMELA/SPIN, C\#, Eiffel, SQL, XML, ER/UML
}
